...
if shape=='gaussian':
    ...
    intensity = (w0/w_z0)**2 * np.exp(-2 * (r/w_z0)**n )
...
#focusing beam
zR = np.pi*w0**2/(lamda) #raylrigh range for guassian beam
...
focal_slice = Field[:,:,idx+1].copy()

I = shadow(focal_slice)**2
